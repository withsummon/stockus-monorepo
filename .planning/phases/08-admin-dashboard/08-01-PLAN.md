...
2. Import icons from lucide-react: LayoutDashboard, BookOpen, FileText, FileSpreadsheet, Users, CreditCard
3. Define navigation array with ONLY implemented pages:
   ...
   NOTE: Do NOT include Videos or Cohorts - these pages are not implemented in this phase.
...
Component renders without errors. TypeScript types correct. Navigation items display properly.
  ...
  <done>
AdminSidebar displays navigation for Dashboard, Courses, Research, Templates, Users, and Orders with proper active state highlighting and admin badge.
  </done>
</task>
...
- Admin users see sidebar with 6 navigation links (Dashboard, Courses, Research, Templates, Users, Orders)
