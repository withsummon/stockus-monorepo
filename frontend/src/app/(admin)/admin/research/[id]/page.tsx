...
import { getAdminResearchById, updateResearch } from '@/lib/api/admin'
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            Update research report details and stock analysis
          </p>
        </div>
      </div>
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="flex gap-4">
            <Button type="submit" disabled={isSubmitting}>
              {isSubmitting ? 'Updating...' : 'Update Research Report'}
            </Button>
            <Button
              type="button"
              variant="outline"
